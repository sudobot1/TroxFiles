...
if DevRio:get(Trox.."Rio:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevRio:sadd(Trox.."Rio:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevRio:get(Trox.."Rio:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
TroxName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if TroxName then 
TroxNames = DevRio:smembers(Trox.."Rio:Mute:Names"..msg.chat_id_) or ""
if TroxNames and TroxNames[1] then 
for i=1,#TroxNames do 
if TroxName:match("(.*)("..TroxNames[i]..")(.*)") then 
...
DevRio:set(Trox.."Rio:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevRio:del(Trox.."Rio:Lock:MuteNames"..msg.chat_id_)
end
end
end
